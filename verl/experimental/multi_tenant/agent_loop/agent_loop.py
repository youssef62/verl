...
class DecoupledLLMServerManager(AsyncLLMServerManager):
    """DecoupledLLMServerManager supports resume generation on partial rollout, making rollout interruption
...
@ray.remote
class DecoupledAgentLoopWorker(AgentLoopWorker):
    def __init__(
        self,
        config: DictConfig,
        ...
        self.server_manager = DecoupledLLMServerManager(config, servers, load_balancer_handle)
        super().__init__(config, servers, load_balancer_handle, reward_loop_worker_handles)


class DecoupledAgentLoopManager(AgentLoopManager):
    def __init__(
        self,
        config: DictConfig,
        ...
        self.agent_loop_workers_class = DecoupledAgentLoopWorker
